...
Lateral Movement: Identification of users accessing an anomalous number of unique computers.

Brute Force Patterns: Detection of repeated authentication failures followed by a successful login.

Protocol Anomalies: Monitoring for unusual usage of legacy authentication protocols, such as NTLM.
